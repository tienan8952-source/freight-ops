...
- **出現在哪份文件**：`docs/briefs/00-總控.md`「待討論事項」
- **標記日期**：2026-09-18
- **狀態**：**未回答**——真實薪資表尚未提供，顯示層要處理多少種髒資料、欄位長什麼樣子都還不知道，需要使用者提供實際的薪資表檔案才能繼續談規格。

## 5. 報價單實際長相未知

- **出現在哪份文件**：`docs/briefs/00-總控.md`「待討論事項」
- **標記日期**：2026-09-18
- **狀態**：**未回答**——報價單的實際長相未知，還沒辦法談規格，需要使用者提供實際的報價單範例。

## 6. 逐字稿是否要自動摘要

- **出現在哪份文件**：`docs/briefs/00-總控.md`「待討論事項」
- **標記日期**：2026-09-18
- **狀態**：**暫緩**——牽涉 API 付費，目前先不做。需要使用者確認要不要投入這筆費用才能重新評估，不算查不到，是刻意擱置。
